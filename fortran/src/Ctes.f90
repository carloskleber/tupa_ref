module mCtes
  ...
  real(8), parameter :: FOUR_PI =  4. * acos(-1.)
  ...
  complex(8), parameter :: ZERO_CPLX = (0.0d0, 0.0d0) !! Zero complex number
  complex(8), parameter :: ONE_CPLX = (1.0d0, 0.0d0) !! One complex number
